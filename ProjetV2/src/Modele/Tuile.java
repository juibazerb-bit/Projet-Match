...
/**
 * Une tuile du plateau.
 * Connaît son type (index dans TypeTuile) et sa position visuelle Y
 * utilisée pendant les animations de chute.
 *
 * La méthode dessiner() prend un Graphics2D : la Tuile ne dépend plus
 * de FenetreGraphique, ce qui supprime un couplage inutile.
 */
public class Tuile {
    ...
    public double getPosYVisuelle()           { return posYVisuelle; }
    public void   setPosYVisuelle(double y)   { this.posYVisuelle = y; }

    // --- Affichage ---

    /**
     * Dessine la tuile à la position (x, y) de la grille.
     * Si une animation est en cours (posYVisuelle != -1), utilise posYVisuelle comme ordonnée.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Tuile)) return false;
