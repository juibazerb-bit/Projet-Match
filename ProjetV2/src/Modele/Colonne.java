...
/**
 * Représente une colonne du plateau : une liste ordonnée de tuiles,
 * de l'indice 0 (bas) au dernier indice (haut).
 *
 * Quand des tuiles sont supprimées, les tuiles restantes descendent
 * et de nouvelles tuiles aléatoires sont ajoutées en haut.
 */
public class Colonne {
    ...
    public Tuile getTuile(int ligne)    { return tuiles.get(ligne); }
    public int   getNbTypes()           { return nbTypes; }
    public void  setNbTypes(int n)      { this.nbTypes = n; }
    public ArrayList<Tuile> getTuiles() { return tuiles; }
