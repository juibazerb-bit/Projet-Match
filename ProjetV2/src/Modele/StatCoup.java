 ...
 * Monte-Carlo : nombre d'apparitions, score total, tuiles supprimées,
 * et historique des scores pour calculer l'écart-type.
 */
public class StatCoup {
    ...
    /** Retourne true si ce StatCoup correspond à la même paire (peu importe l'ordre). */
     ...
     * Retourne 0 si moins de 2 occurrences.
     */
