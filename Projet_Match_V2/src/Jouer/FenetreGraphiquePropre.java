...
public class FenetreGraphiquePropre extends javax.swing.JFrame {
    ...
    private void configurerSpinners() {
        ...
        TailleTuiles.setModel(new javax.swing.SpinnerNumberModel(taille, 1, 100, 1));
    }
    ...
    private void configurerPanneauJeu() {
        ...
        conteneurCentreur.setBackground(Color.WHITE);
        // Ajouter la grille dans ce conteneur (sans contraintes, elle se place au centre)
        conteneurCentreur.add(panneauJeu);

        // Mettre le conteneur dans le JScrollPane à la place de la grille seule
        scrollGrille.setViewportView(conteneurCentreur);

        // Conserver ton écouteur de clics
        panneauJeu.setCoupJouer(() -> {
            coupsJoues++;
            mettreAJourScore();
        });

        // ChangeListener sur le spinner TailleTuiles : mise à jour en temps réel
        TailleTuiles.addChangeListener(e -> {
            int t = (int) TailleTuiles.getValue();
            taille = t;
    ...
    private void initialiserPlateau(int lignes, int colonnes, int types,int taill) {
        ...
        Tuile.TAILLE = taill;                           // synchronise l'interface legacy
        panneauJeu.setTailleTuile(taill);               // doit être avant setPreferredSize
    ...
    private void initComponents() {
        ...
        panneauConteneur.setBackground(new java.awt.Color(107, 108, 220));
        ...
        MenuPrincipal.setBackground(new java.awt.Color(107, 108, 220));
        MenuPrincipal.setForeground(new java.awt.Color(107, 108, 220));
        ...
        MenuNiveaux.setBackground(new java.awt.Color(107, 108, 220));
        ...
        EcranJeu.setBackground(new java.awt.Color(107, 108, 220));
        EcranJeu.setLayout(new java.awt.BorderLayout());

        scrollGrille.setBackground(new java.awt.Color(51, 0, 102));
        scrollGrille.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_ALWAYS);
        scrollGrille.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        EcranJeu.add(scrollGrille, java.awt.BorderLayout.CENTER);

        MenuJeu.setBackground(new java.awt.Color(107, 108, 220));
        ...
        champScore4.setBackground(new java.awt.Color(107, 108, 220));
        champScore4.setForeground(new java.awt.Color(255, 255, 255));
        champScore4.setText("0");

        barreScore4.setBackground(new java.awt.Color(107, 108, 220));
        ...
        zoneMessages4.setBackground(new java.awt.Color(107, 108, 220));
        ...
        labelTypes5.setBackground(new java.awt.Color(51, 0, 102));
        labelTypes5.setForeground(new java.awt.Color(255, 255, 255));
        labelTypes5.setText("Taille des Tuiles : ");
        ...
        MenuJeuLayout.setHorizontalGroup(
            ...
            .addGroup(MenuJeuLayout.createSequentialGroup()
                ...
                .addContainerGap())
            .addGroup(MenuJeuLayout.createSequentialGroup()
                .addComponent(labelTypes5, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(TailleTuiles, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        MenuJeuLayout.setVerticalGroup(
            ...
            .addGroup(MenuJeuLayout.createSequentialGroup()
                ...
                .addGap(13, 13, 13)
                .addGroup(MenuJeuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(labelTypes5)
                    .addComponent(TailleTuiles, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private javax.swing.JSpinner TailleTuiles;
    ...
    private javax.swing.JLabel labelTypes5;
