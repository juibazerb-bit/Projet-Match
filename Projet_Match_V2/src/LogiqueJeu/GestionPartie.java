...
/**
 * Gère la logique d'un coup joué : 1. Tente l'échange de deux tuiles voisines.
 * 2. Vérifie qu'un match est créé. 3. Si oui : supprime les matchs en cascade,
 * retourne true. 4. Si non : annule l'échange, retourne false.
 *
 * Cette classe ne fait PAS d'affichage ni d'animation : c'est le rôle de
 * l'appelant (PanneauJeu, TestNiveau…) d'appeler le rendu après.
 */
