...
/**
 * Enumération de tous les effets sonores du jeu. Chaque son est chargé une
 * seule fois au démarrage depuis le dossier sons/.
 *
 * Utilisation : SonManager.jouer(Son.MATCH_SIMPLE);
